...
router.use("/modules", verifyToken,  ModuleController);
router.use("/users", verifyToken,  UserController);
router.use("/roles", verifyToken,  RoleController);
router.use("/userRoles", verifyToken,  UserRoleController);
router.use("/permissions", verifyToken,  PermissionController);
router.use("/rolePermissions", verifyToken, RolePermissionController);
